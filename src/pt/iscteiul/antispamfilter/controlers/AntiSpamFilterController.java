...
public class AntiSpamFilterController {
	...
	public void saveConfiguration() throws FileNotFoundException {
		...
		PrintWriter fileWriterrulesTF = new PrintWriter("AntiSpamConfigurationForLeisureMailbox/rules.cf");
	...
	public void overwriteSavedConfiguration() throws FileNotFoundException {
		...
		PrintWriter fileWriterrules = new PrintWriter("AntiSpamConfigurationForLeisureMailbox/rules.cf");
		for (int i = 0; i < regras.size(); i++) {
